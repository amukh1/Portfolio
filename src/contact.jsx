...
export default function App() {
  return (
    <main>
        ...
        <br />
        <a href="https://discord.com/users/696953667403644938" className="contact-link">Discord: amukh1#9613</a>
        <br />
        <a href="https://github.com/amukh1" className="contact-link">Github: amukh1</a> 
    </div>
